...
namespace AirLineApi.Util
{
    public class Security
    {
        /*
         ...
         Date: 5/11/2021
         Desc: Encripta strings con clave interna de intelecto
         Params: data(string)
         Response: string
         */
        public static string Encrypt(string Data, int Bits = 256, string Password = "P0M4RR0S4-D3V3L0PM3NT-H4SH-W3B2022")
        {
        ...
        /*
         Author: Andres Camacho
         Date: 5/11/2021
         Desc: Encripta datos de string en bytes
         Params: byte[] clearData, byte[] Key, byte[] IV
         Response: byte[]
         */
        ...
        /*
         Author: Andres Camacho
         Date: 5/11/2021
         Desc: Desencripta strings con clave interna de intelecto
         Params: data(string)
         Response: string
         */
        public static string Decrypt(string Data, int Bits = 256, string Password = "P0M4RR0S4-D3V3L0PM3NT-H4SH-W3B2022")
        {
            try
            {
        ...
        /*
         Author: Andres Camacho
         Date: 5/11/2021
         Desc: Desecncripta datos de string en bytes
         Params: byte[] clearData, byte[] Key, byte[] IV
         Response: byte[]
         */
